...
# Google Colab specific library for drive access (if using Colab)
...
# Configure matplotlib to use a specific style
plt.style.use('classic')

# Override default pandas_datareader behavior with Yahoo Finance
yfin.pdr_override()
...
budget_2017 = 0
budget_2019 = 10000
budget_2022 = [sum(portfolio_quantities_tf[i].values()), sum(portfolio_quantities_tf_opt1[i].values()),sum(portfolio_quantities_tf_opt2[i].values()),sum(portfolio_quantities_tf_opt3[i].values())]
